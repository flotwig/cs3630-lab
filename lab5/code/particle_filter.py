...
MIN_PROBABILITY = .1  # particles with p < this will be removed
...
def motion_update(particles, odom):
    ...
    for particle in particles:
        ...
        particle.h += proj_angle_deg(pdelta_rot1 + pdelta_rot2)
    return particles
...
def measurement_update(particles, measured_marker_list, grid):
    ...
    measured_particles = np.random.choice(particles, p=probabilities, size=4700)
    # let's aim for 5000 particles
